...
# User inputs ------------------------------------------------------------------
project <- 'stilt_run_heavy'
stilt_wd <- file.path('/shared/stilt_run_heavy/')
...
n_nodes <- 1
#n_nodes <- 100
#cody's rule of thumb was nodes = half the number of receptors
#cap it at ~500
...
met_directory  <- file.path('/shared/')
